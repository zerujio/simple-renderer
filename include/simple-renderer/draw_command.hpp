...
struct DrawArraysInstancedCommand : DrawArraysCommand, InstancedDrawCommand
{
    ...
    DrawArraysInstancedCommand(const DrawArraysCommand &draw_arrays, std::uint32_t instance_count)
...
struct DrawElementsInstancedCommand : DrawElementsCommand, InstancedDrawCommand
{
    ...
    DrawElementsInstancedCommand(DrawElementsCommand draw_elements, std::uint32_t instance_count)
