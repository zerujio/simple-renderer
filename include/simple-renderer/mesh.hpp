...
namespace simple {
    ...
    public:
        ...
        explicit Mesh(glutils::Guard<glutils::Buffer> buffer, glutils::Guard<glutils::VertexArray> vertex_array,
                      GLenum draw_mode, GLsizei index_count, GLint first_index, GLsizei instance_count = 0) :
        ...
        [[nodiscard]]
        GLsizei getInstanceCount() const {return m_instance_count;}
        void setInstanceCount(GLsizei count) {m_instance_count = count;}
        [[nodiscard]]
        bool usesInstancedDrawing() const {return getInstanceCount();}
    ...
    private:
        ...
        GLsizei m_instance_count {0};   // used for instanced rendering
        union {
